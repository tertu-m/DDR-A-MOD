...
local path = THEME:GetAbsolutePath("Graphics/ScreenSelectStyle Icon/single/");
...
t[#t+1] = Def.ActorFrame{
  ...
  Def.ActorFrame{
    LoadActor(THEME:GetPathG("","_shared/SelectStyle/infomiddle"))..{
      ...
      On1Command=cmd(diffusealpha,0;zoomy,0;sleep,0.5;smooth,0.2;zoomy,1;diffusealpha,1);
