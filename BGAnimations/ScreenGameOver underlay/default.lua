...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor( "thanks" )..{
		InitCommand=cmd(zoomto,SCREEN_WIDTH,SCREEN_HEIGHT;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;blend,'BlendMode_NoEffect';zwrite,true;clearzbuffer,false;sleep,0.334;linear,4.933;zoom,0.791;);
	};
	LoadActor( "konami" )..{
