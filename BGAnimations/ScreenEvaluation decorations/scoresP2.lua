...
InitCommand=cmd(addy,-30+3);
	...
	InitCommand=cmd(zoom,1;shadowlength,2;x,SCREEN_CENTER_X+245+22+22;y,SCREEN_CENTER_Y+80+8;horizalign,center;draworder,1);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
...
t[#t+1] = LoadActor("ScoreFrame.png")..{
	InitCommand=cmd(player,PLAYER_2;vertalign,top;x,SCREEN_CENTER_X+245;y,SCREEN_CENTER_Y+80-30-20+5;zoom,0.7);
