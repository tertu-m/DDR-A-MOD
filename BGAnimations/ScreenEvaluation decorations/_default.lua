...
t[#t+1] = LoadActor("p1result")..{
		InitCommand=cmd(x,SCREEN_LEFT+65;y,SCREEN_CENTER_Y-268-2;player,PLAYER_1;zoom,1.25);
...
--ScoreLabelP2
t[#t+1] = LoadActor("Score_Label")..{
	InitCommand=cmd(diffusealpha,1;draworder,11;x,SCREEN_CENTER_X+320-120+7;y,SCREEN_CENTER_Y-90+5;visible,GAMESTATE:IsHumanPlayer(PLAYER_2);zoom,0.7);
	OffCommand=cmd(sleep,0.2;linear,0.2;diffusealpha,0);
};
--CaloriesP1
...
t[#t+1] = Def.RollingNumbers {
			File = THEME:GetPathF("ScreenEvaluation", "ScoreNumber");
			InitCommand=cmd(x,SCREEN_CENTER_X+310+45;y,SCREEN_CENTER_Y-47.5;zoomx,1;zoomy,0.95;player,PLAYER_2;playcommand,"Set");
			SetCommand = function(self)
...
t[#t+1] = LoadFont("_arial black 28px")..{
	InitCommand=cmd(horizalign,center;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y-70-2;zoom,0.64);
	OffCommand=cmd(linear,0.15;diffusealpha,0);
	OnCommand=function(self)
	local song = GAMESTATE:GetCurrentSong();
	local course = GAMESTATE:GetCurrentCourse();
...
--artist--
t[#t+1] = LoadFont("_arial black 28px")..{
	InitCommand=cmd(horizalign,center;x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+30-70-5;zoom,0.5;draworder,2);
	OffCommand=cmd(linear,0.15;diffusealpha,0);
	OnCommand=function(self)
	local song = GAMESTATE:GetCurrentSong();
	local course = GAMESTATE:GetCurrentCourse();
