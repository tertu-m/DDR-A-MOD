...
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.5;draworder,6;y,SCREEN_CENTER_Y-179;horizalign,right;addx,15);
...
--Marvelous--
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+217-12;horizalign,right;addx,15);
	OnCommand=function(self)
...
--Perfect--
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+242-12;horizalign,right;addx,15);
	OnCommand=function(self)
...
--Great--
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+267-12;horizalign,right;addx,15);
	OnCommand=function(self)
		self:settextf(Great);
		self:diffuse(color("#000000"));
		self:strokecolor(color("#ffffff"));
...
--Good--
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+292-12;horizalign,right;addx,15);
	OnCommand=function(self)
		self:settextf(Good);
		self:diffuse(color("#000000"));
		self:strokecolor(color("#ffffff"));
...
--Ok--
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+317-12;horizalign,right;addx,15);
	OnCommand=function(self)
		self:settextf(Ok);
		self:diffuse(color("#000000"));
		self:strokecolor(color("#ffffff"));
...
--Miss--(Almost+Miss)
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.42;draworder,5;y,SCREEN_TOP+342-12;horizalign,right;addx,15);
	OnCommand=function(self)
		self:settextf(Miss);
		self:diffuse(color("#000000"));
		self:strokecolor(color("#ffffff"));
...
--EXScore
t[#t+1] = LoadFont("_avantgarde-book 40px")..{
	InitCommand=cmd(player,PLAYER_2;zoom,0.5;draworder,5;y,SCREEN_TOP+356;horizalign,right;addx,15);
	OnCommand=function(self)
