...
-- 			local Meter = self:GetChild("Meter"
		...
		LoadFont("_helvetica-compressed 32px") .. {
			...
			ShowCommand=cmd(stoptweening;linear,0.1;;diffuse,color("0,0,0,1");zoomx,0.40);
			...
			UnSelectCommand=cmd(stoptweening;decelerate,0.2;shadowlength,0;diffuse,color("0,0,0,1");zoomx,0.40);
		};
		...
		LoadFont("_itc machine std 20px") .. {
			...
			InitCommand=cmd(x,28-378;y,tLocation[sDifficulty]-5;shadowlength,1;zoomx,0.75;zoomy,0.75;strokecolor,CustomDifficultyToDarkColor(sDifficulty));
...
-- 			local Meter = self:GetChild("Meter"
			...
			-- self:playcommand(curDiff==diff and "Show" or "UnSelect");
		...
		LoadFont("_itc machine std 20px") .. {
			...
			ShowCommand=cmd(stoptweening;linear,0.1;diffuse,color( "1,1,1,1" );strokecolor, color( "0,0,0,1" ));
			HideCommand=cmd(stoptweening;decelerate,0.2;shadowlength,0;diffuse,color( "0.5,0.5,0.5,0.5" );strokecolor, color( "0.1,0.1,0.1,0.5" ));
			InitCommand=cmd(x,-28+376;y,tLocation[sDifficulty]-5;shadowlength,1;zoomx,0.75;zoomy,0.75;strokecolor,CustomDifficultyToDarkColor(sDifficulty));
			UnSelectCommand=cmd(stoptweening;decelerate,0.2;shadowlength,1.1;diffuse,color( "1,1,1,1" );strokecolor, color( "0,0,0,1" ));
		};
