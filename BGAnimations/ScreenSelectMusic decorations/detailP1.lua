...
InitCommand=cmd(addy,-110);
	...
	InitCommand=cmd(player,PLAYER_1;zoom,0.8;shadowlength,1;x,SCREEN_CENTER_X+47+offsetx;y,SCREEN_CENTER_Y+80+195;horizalign,center;draworder,2);
...
InitCommand=cmd(addy,-110);
	Def.Quad{
	InitCommand=cmd(player,PLAYER_1;zoom,0.7;shadowlength,1;x,SCREEN_CENTER_X+offsetx;y,SCREEN_CENTER_Y+100+165;horizalign,center;draworder,2);
	OffCommand=cmd(bouncebegin,0.15;zoom,0);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
