...
local t=Def.ActorFrame {
	...
	Def.RollingNumbers {
		...
		InitCommand=cmd(zoom,0.8;shadowlength,2;x,SCREEN_RIGHT-175+155;y,SCREEN_CENTER_Y-160-43-6.5-30+38;horizalign,right;diffuse,color("#000000");strokecolor,color("White"));
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	Def.Quad{
	InitCommand=cmd(zoom,0.4;shadowlength,2;x,SCREEN_RIGHT-175+22;y,SCREEN_CENTER_Y-160-43-6.5-30+38;horizalign,center);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	InitCommand=cmd(zoom,1;shadowlength,2;x,SCREEN_RIGHT-175+22+22;y,SCREEN_CENTER_Y-160-43-6.5-30+45;horizalign,center;draworder,1);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
