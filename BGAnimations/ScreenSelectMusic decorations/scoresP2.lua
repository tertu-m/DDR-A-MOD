...
local t=Def.ActorFrame {
	...
	Def.RollingNumbers {
		...
		InitCommand=cmd(zoom,1.2;shadowlength,0;x,SCREEN_RIGHT-175+123;y,SCREEN_CENTER_Y-160-43-6.5-30+38-9;horizalign,right;diffuse,Color("White"));
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	InitCommand=cmd(zoom,1;shadowlength,2;x,SCREEN_RIGHT-175+22+22-100;y,SCREEN_CENTER_Y-160-43-6.5-30+45;horizalign,center;draworder,1);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
	...
	Def.Quad{
	InitCommand=cmd(zoom,0.3;shadowlength,2;x,SCREEN_RIGHT-175+22-100;y,SCREEN_CENTER_Y-160-43-6.5-30+38;horizalign,center;draworder,2);
		BeginCommand=cmd(playcommand,"Set");
		SetCommand=function(self)
			local SongOrCourse, StepsOrTrail;
			if GAMESTATE:IsCourseMode() then
...
t[#t+1] = LoadActor("ScoreBack01")..{
	InitCommand=cmd(player,PLAYER_2;vertalign,top;rotationy,180;x,SCREEN_RIGHT-225;y,SCREEN_CENTER_Y-160-43-6.5-30+20-80;zoom,0.8);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = LoadActor(lang.."_ScoreFrame")..{
	InitCommand=cmd(player,PLAYER_2;vertalign,top;x,SCREEN_RIGHT-225;y,SCREEN_CENTER_Y-160-43-6.5-30+20-80;zoom,0.8);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = LoadActor("ScoreBack02")..{
	InitCommand=cmd(player,PLAYER_2;vertalign,top;x,SCREEN_RIGHT-360;y,SCREEN_CENTER_Y-160-43-6.5-30+20-30;zoom,0.8);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
...
t[#t+1] = RivalScore(PLAYER_2,2)..{
	InitCommand=cmd(addy,30.75);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = RivalScore(PLAYER_2,3)..{
	InitCommand=cmd(addy,30.75*2);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = RivalScore(PLAYER_2,4)..{
	InitCommand=cmd(addy,30.75*3);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = RivalScore(PLAYER_2,5)..{
		InitCommand=cmd(addy,30.75*4);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = RivalScore(PLAYER_2,6)..{
	InitCommand=cmd(addy,30.75*5);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
t[#t+1] = RivalScore(PLAYER_2,7)..{
	InitCommand=cmd(addy,30.75*6);
	OffCommand=cmd(sleep,0.15;linear,0.25;addx,500);
	};
