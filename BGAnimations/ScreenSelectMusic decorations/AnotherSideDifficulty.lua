...
local t = Def.ActorFrame {
	OnCommand=function(self)
		if GAMESTATE:IsPlayerEnabled(player) then
			...
			if ReadOrCreatePaneControlForAnotherSide(PlayerUID) == "OpenPanesA1" and string.match( style, "OnePlayer" ) then
				self:linear(0.5);
				self:diffusealpha(1)
				ThisPlayerPaneIsOpen = true
			elseif ReadOrCreatePaneControlForAnotherSide(PlayerUID) == "OpenPanesA2" or ReadOrCreatePaneControlForAnotherSide(PlayerUID) == "OpenPanesA3" 
			then
				self:diffusealpha(0);
				ThisPlayerPaneIsOpen = false
			end
		   
			if ReadOrCreatePaneControlForAnotherSide(PlayerUID) == "ClosePanesA"  then
				ThisPlayerPaneIsOpen = false
				self:diffusealpha(0)
			end
		end;
	...
	CodeMessageCommand=function(self,params)
		if params.PlayerNumber == player then
			local style = GAMESTATE:GetCurrentStyle():GetStyleType()
			if params.Name == "OpenPanesA1" and not ThisPlayerPaneIsOpen and string.match( style, "OnePlayer" ) then
				self:diffusealpha(1)
				ThisPlayerPaneIsOpen = true
			elseif params.Name == "OpenPanesA2" or params.Name == "OpenPanesA3" --or params.Name == "SortList" or params.Name == "SortList2" or params.Name == "SortList3" 
			then
				self:diffusealpha(0);
				ThisPlayerPaneIsOpen = false	
			end
			if params.Name == "ClosePanesA" --or params.Name == "SortList" or params.Name == "SortList2" or params.Name == "SortList3"  
			then
				ThisPlayerPaneIsOpen = false
				self:diffusealpha(0)
			end
